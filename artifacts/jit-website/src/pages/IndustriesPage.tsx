        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {industries.map(({ name, desc, icon }) => (
              <div
                key={name}
                className="group flex flex-col items-center gap-3 p-6 md:p-8 rounded-2xl bg-secondary hover:bg-primary hover:shadow-lg transition-all duration-300 text-center"
              >
